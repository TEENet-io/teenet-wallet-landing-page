...
export default function Footer({ content, locale }: FooterProps) {
  function handleLinkClick(link: string) {
    trackEvent('footer_link', { locale, link })
  }

  return (
    <footer className="border-t border-gray-200 bg-white py-12 px-6">
      <div className="max-w-6xl mx-auto">
        {/* Brand line + social icons */}
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-10">
          <p className="text-gray-700 font-semibold">{content.brandLine}</p>
        ...
        {/* Bottom line */}
        <p className="text-sm text-gray-400 mt-8 pt-8 border-t border-gray-200">
          {content.bottomLine}
        </p>
      </div>
    </footer>
